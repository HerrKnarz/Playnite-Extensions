...
namespace LinkUtilities.Interfaces
{
    ...
    /// <summary>
    /// Interface for classes, that can be used as a link action. Contains texts for the progress
    /// bar, result dialog and the action to execute.
    /// </summary>
    public interface ILinkAction
    {
        ...
        /// <summary>
        /// Prepares the link action before performing the execute method. Should be executed before
        /// a loop containing the Execute method.
        /// </summary>
        /// <param name="actionModifier">
        /// Optional modifier for the underlying class to do different things in the execute method
        /// </param>
