...
{
    public class ScreenshotUtilitiesGOGProviderSettings : ObservableObject
    {
    ...
    public class ScreenshotUtilitiesGOGProviderSettingsViewModel : ObservableObject, ISettings
    {
        ...
        public ScreenshotUtilitiesGOGProviderSettingsViewModel(ScreenshotUtilitiesGOGProvider plugin)
        {
            ...
            // Load saved settings.
            var savedSettings = plugin.LoadPluginSettings<ScreenshotUtilitiesGOGProviderSettings>();
            ...
            {
                Settings = new ScreenshotUtilitiesGOGProviderSettings();
            }
        }
