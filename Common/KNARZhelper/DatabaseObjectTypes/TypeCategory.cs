...
namespace KNARZhelper.DatabaseObjectTypes
{
    public class TypeCategory : BaseType
    {
        ...
        public override bool DbObjectInUse(List<Game> games, Guid id) => games.Any(x => x.CategoryIds?.Contains(id) ?? false);
        ...
        public override int GetGameCount(List<Game> games, Guid id, bool ignoreHidden = false) =>
            games.Count(g => !(ignoreHidden && g.Hidden) && (g.CategoryIds?.Contains(id) ?? false));
