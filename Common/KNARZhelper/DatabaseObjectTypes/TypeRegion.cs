...
namespace KNARZhelper.DatabaseObjectTypes
{
    public class TypeRegion : BaseType
    {
        ...
        public override string Label => ResourceProvider.GetString("LOCRegionsLabel");
        ...
        public override bool FieldInGameIsEmpty(Game game) => !game.RegionIds?.Any() ?? true;
        ...
        public override bool RemoveDbObject(Guid id, bool checkIfUsed = true) =>
            ...
            checkIfUsed
                ...
                : API.Instance.MainView.UIDispatcher.Invoke(() => API.Instance.Database.Regions.Remove(id));
