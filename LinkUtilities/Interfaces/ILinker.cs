...
public interface ILinker
{
    ...
    Task<bool> AddSearchedLinkAsync(Game game, bool skipExistingLinks = false, bool cleanUpAfterAdding = true);
    ...
    Task<(List<WebLink> links, bool result)> FindLinksAsync(Game game);
    ...
    string GetBrowserSearchLink(Game game);
    ...
    Task<string?> GetGamePathAsync(Game game, string? gameName = null);
    ...
    Task<IEnumerable<ChooseDialogItem>> GetSearchResultsAsync(ChooseItemWithSearchAsyncArgs searchArgs);
    ...
    bool StartBrowserSearch(Game game);
}