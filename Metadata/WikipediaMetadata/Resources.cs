...
public static class Resources
{
    ...
    /// </summary>
    public static readonly List<LinkPair> LinkPairs =
    [
        new LinkPair
        {
            Contains = "gamefaqs.gamespot.com",
            Name = "GameFAQs"
        },

        new LinkPair
        {
            Contains = "giantbomb.com",
            Name = "Giant Bomb"
        },
        ...
        new LinkPair
        {
            Contains = "arcade-museum.com",
            Name = "Killer List of Videogames"
        },

        new LinkPair
        {
            Contains = "metacritic.com",
            Name = "Metacritic"
        },

        new LinkPair
        {
            Contains = "mobygames.com",
            Name = "MobyGames"
        },
    ...
    /// </summary>
    public static readonly List<string> PlatformCodes =
    [
